# EPIC-01: Proxy foundation

## Mål

Bygg OpenAI-kompatibel ingress som kan ta emot, validera och proxya chat completions.
...
- Streaming och non-streaming
- Request id och tracing
- Grundläggande auth
- Mock provider
...
Se `05-issues/issue-index.md` och filtrera på `epic: EPIC-01`.
